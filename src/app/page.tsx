...
export default function ImperiaEventBattleLanding() {
  ...
  return (
    <div className="bg-black text-white min-h-screen font-[system-ui,-apple-system,BlinkMacSystemFont,'SF_Pro_Display','SF_Pro_Text','Helvetica_Neue',Arial,sans-serif] antialiased tracking-[-0.02em]">
  ...
  <div className="mx-auto flex h-[96px] max-w-7xl items-center justify-between rounded-full border border-white/10 bg-black/85 px-5 md:px-8 shadow-[0_20px_80px_rgba(0,0,0,0.45)] backdrop-blur-xl">
    ...
    <div className="hidden md:flex items-center gap-4">
      ...
      <Button className="h-[90px] rounded-full border border-amber-200/20 bg-amber-300/90 backdrop-blur-md text-black px-8 text-[20px] font-normal tracking-[-0.03em] leading-[1.05] hover:bg-amber-200 transition-all shadow-[0_8px_40px_rgba(255,210,120,0.18)]">
      ...
      <section className="px-8 md:px-20 pt-8 pb-24">
      ...
      <section className="px-8 md:px-20 py-28 relative overflow-hidden">
        <div className="absolute right-[-12%] top-[12%] h-[360px] w-[360px] rounded-full bg-amber-300/5 blur-[130px]"></div>

        <div className="mx-auto grid max-w-7xl gap-14 md:grid-cols-[0.95fr_1.05fr] md:items-start">
          <div>
            <div className="mb-6 inline-flex items-center gap-3 rounded-full border border-white/10 bg-white/[0.03] px-5 py-2 text-[15px] font-light tracking-[0.18em] text-zinc-300 backdrop-blur-md">
              <div className="h-2 w-2 rounded-full bg-amber-300 shadow-[0_0_18px_rgba(255,210,120,0.9)]"></div>
              О НАС
            ...
            <p className="mt-8 max-w-2xl text-[24px] font-light leading-[1.35] tracking-[-0.035em] text-zinc-300">
          ...
          <div className="space-y-5">
            <div className="rounded-[32px] border border-white/10 bg-zinc-950/70 p-8 backdrop-blur-md transition-all duration-500 hover:border-amber-300/25 hover:bg-zinc-900/80">
              <div className="mb-3 text-[15px] font-light uppercase tracking-[0.22em] text-amber-300/80">Партнёр / управление</div>
              <h3 className="text-[30px] font-extralight tracking-[-0.045em] text-white">Дмитрий Владимирович Молев</h3>
              <p className="mt-5 text-[18px] font-light leading-[1.65] tracking-[-0.03em] text-zinc-400">
                Отвечает за продажи, рекламу, коммуникацию с клиентами, подготовку и согласование договоров, контроль оплат и полное сопровождение проекта с организационной стороны.
              </p>
            </div>

            <div className="rounded-[32px] border border-white/10 bg-zinc-950/70 p-8 backdrop-blur-md transition-all duration-500 hover:border-amber-300/25 hover:bg-zinc-900/80">
              <div className="mb-3 text-[15px] font-light uppercase tracking-[0.22em] text-amber-300/80">Партнёр / продакшн</div>
              <h3 className="text-[30px] font-extralight tracking-[-0.045em] text-white">Оксана Александровна Карташова</h3>
              <p className="mt-5 text-[18px] font-light leading-[1.65] tracking-[-0.03em] text-zinc-400">
                Отвечает за офлайн-продажи, разработку концепций мероприятий, подбор и координацию подрядчиков, проведение мероприятий и контроль реализации проекта на площадке.
              </p>
            </div>

            <div className="rounded-[32px] border border-amber-300/20 bg-amber-300/[0.06] p-8 backdrop-blur-md">
              <h3 className="text-[28px] font-extralight tracking-[-0.045em] text-amber-100">Без роботов и автоответчиков</h3>
              <p className="mt-5 text-[18px] font-light leading-[1.65] tracking-[-0.03em] text-zinc-300">
                Только личное общение — в чате и по телефону напрямую с основателями проекта. Мы лично сопровождаем каждый этап подготовки мероприятия и остаёмся на связи с клиентом до завершения события.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="px-8 md:px-20 py-28 bg-black relative overflow-hidden">
      ...
      <footer className="px-8 md:px-20 py-20 border-t border-white/10 bg-black relative overflow-hidden">
